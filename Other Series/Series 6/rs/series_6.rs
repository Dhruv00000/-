...
fn main() {
    ...
    loop {
        ...
        approximation += ((4.0 / (4*iterator + 1) as f64) + (4.0 / (8*iterator + 3) as f64) - (1.0 / (8*iterator + 7) as f64) + (1.0 / (2*iterator + 1) as f64)) / (2.0 * f64::powf(16.0, iterator as f64)); // 16^a is written as an f64::powf() instead of a u32::pow() to avoid dealing with overflow through multiplication errors.

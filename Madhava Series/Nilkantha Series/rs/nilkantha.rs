...
fn main() {
    ...
    let mut approximation_intermedaite: f64 = 0.0;
    ...
    loop {
        ...
        approximation_intermedaite += i8::pow(-1, iterator as u32 + 1) as f64 / (iterator * (iterator + 1) * (2*iterator + 1)) as f64;
        approximation = approximation_intermedaite + 3.0;

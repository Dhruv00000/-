...
fn main() {
    ...
    let mut approximation_cubed: f64 = 0.0;
    ...
    loop {
        ...
        approximation_cubed += 32.0 * f64::powf(i8::pow(-1, iterator) as f64 / (2*iterator + 1) as f64, 3.0);
        approximation = f64::powf(approximation_cubed, 1.0/3.0);

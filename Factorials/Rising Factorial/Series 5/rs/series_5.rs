...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += (f64::powf(4.0/85.0, iterator as f64) * (133*iterator + 8) as f64 * rising_factorial(1.0/6.0, iterator) * rising_factorial(1.0/2.0, iterator) * rising_factorial(5.0/6.0, iterator)) / u128::pow(factorial(iterator), 3) as f64;
        approximation = (85.0 * f64::powf(85.0, 1.0/2.0)) / (18.0 * f64::powf(3.0, 1.0/2.0) * approximation_inverted);

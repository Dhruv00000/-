...
while True:
    ...
    approximationInverted += Decimal(pow(4 / 85, k ) * (133*k + 8) * risingFactorial(1/2, k) * risingFactorial(1/6, k) * risingFactorial(5/6, k) / pow(factorial(k), 3))
    approximation = 85 * Decimal(pow(85, 1/2)) / (18 * Decimal(pow(3, 1/2)) * approximationInverted)

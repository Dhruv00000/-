...
while True:
    ...
    approximationInverted += Decimal((10*k + 1) * risingFactorial(1/2, k) * risingFactorial(1/4, k) * risingFactorial(3/4, k) / (pow(factorial(k), 3) * pow(9, 2*k + 1)))
    approximation = 1 / (2 * Decimal(pow(2, 1/2)) * approximationInverted)

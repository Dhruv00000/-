...
while True:
    ...
    approximationInverted += Decimal(pow(4 / 125, k ) * (33*k + 4) * risingFactorial(1/2, k) * risingFactorial(1/3, k) * risingFactorial(2/3, k) / pow(factorial(k), 3))
    approximation = 15 * Decimal(pow(3, 1/2)) / (2 * approximationInverted)

...
while True:
    ...
    approximationInverted += Decimal((280*k + 19) * risingFactorial(1/2, k) * risingFactorial(1/4, k) * risingFactorial(3/4, k) / (pow(factorial(k), 3) * pow(99, 2*k + 1)))
    approximation = 2 / (Decimal(pow(11, 1/2)) * approximationInverted)

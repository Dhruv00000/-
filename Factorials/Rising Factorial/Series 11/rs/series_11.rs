...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += ((644*iterator + 41) as f64 * rising_factorial(1.0/4.0, iterator) * rising_factorial(1.0/2.0, iterator) * rising_factorial(3.0/4.0, iterator)) / (u128::pow(factorial(iterator), 3) * u128::pow(72, (2*iterator + 1) as u32) * u128::pow(5, iterator as u32)) as f64;
        approximation = 4.0 / (f64::powf(5.0, 1.0/2.0) * approximation_inverted);

...
while True:
    ...
    approximationInverted += Decimal((644*k + 41) * risingFactorial(1/2, k) * risingFactorial(1/4, k) * risingFactorial(3/4, k) / (pow(factorial(k), 3) * pow(72, 2*k + 1) * pow(5, k)))
    approximation = 4 / (Decimal(pow(5, 1/2)) * approximationInverted)

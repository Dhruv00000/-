...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += i8::pow(-1, iterator as u32) as f64 * ((28*iterator + 3) as f64 * rising_factorial(1.0/4.0, iterator) * rising_factorial(1.0/2.0, iterator) * rising_factorial(3.0/4.0, iterator)) / (u128::pow(factorial(iterator), 3) * u128::pow(4, (2*iterator + 1) as u32) * u128::pow(3, iterator as u32)) as f64;
        approximation = 4.0 / (f64::powf(3.0, 1.0/2.0) * approximation_inverted);

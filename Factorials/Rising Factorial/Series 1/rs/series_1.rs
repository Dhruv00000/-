...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += ((6*iterator + 1) as f64 * f64::powf(rising_factorial(1.0/2.0, iterator), 3.0)) / (u128::pow(factorial(iterator), 3) * u128::pow(4, iterator as u32)) as f64;

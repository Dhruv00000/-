...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += i8::pow(-1, iterator as u32) as f64 * ((20*iterator + 3) as f64 * rising_factorial(1.0/4.0, iterator) * rising_factorial(1.0/2.0, iterator) * rising_factorial(3.0/4.0, iterator)) / (u128::pow(factorial(iterator), 3) * u128::pow(2, (2*iterator + 1) as u32)) as f64;

...
while True:
    ...
    approximationInverted += pow(-1, k) * Decimal((20*k + 3) * risingFactorial(1/2, k) * risingFactorial(1/4, k) * risingFactorial(3/4, k) / (pow(factorial(k), 3) * pow(2, 2*k + 1)))
    approximation = 4 / approximationInverted

...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += (f64::powf((f64::powf(5.0, 1.0/2.0) - 1.0) / 2.0, (8*iterator) as f64) * ((42*iterator) as f64 * f64::powf(5.0, 1.0/2.0) + (30*iterator) as f64 + 5.0 * f64::powf(5.0, 1.0/2.0) - 1.0) * f64::powf(rising_factorial(1.0/2.0, iterator), 3.0)) / (u128::pow(64, iterator as u32) * u128::pow(factorial(iterator), 3)) as f64;
        approximation = 32.0 / approximation_inverted;

...
while True:
    ...
    approximationInverted += Decimal(pow(2 / 27, k) * (15*k + 2) * risingFactorial(1/2, k) * risingFactorial(1/3, k) * risingFactorial(2/3, k) / pow(factorial(k), 3))
    approximation = 27 / (4 * approximationInverted)

...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += ((8*iterator + 1) as f64 * rising_factorial(1.0/4.0, iterator) * rising_factorial(1.0/2.0, iterator) * rising_factorial(3.0/4.0, iterator)) / (u128::pow(factorial(iterator), 3) * u128::pow(9, iterator as u32)) as f64;
        approximation = 2.0 * f64::powf(3.0, 1.0/2.0) / approximation_inverted;

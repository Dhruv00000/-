...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += 12.0 * i8::pow(-1, iterator as u32) as f64 * (factorial(6*iterator) * (545140134 * (iterator as u128) + 13591409)) as f64 / (factorial(3*iterator) * u128::pow(factorial(iterator), 3)) as f64 / f64::powf(640320.0, (3*iterator) as f64 + 3.0/2.0);
        approximation = 1.0 / approximation_inverted;

...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += (factorial(4*iterator) * (26390 * (iterator as u128) + 1103)) as f64 / (u128::pow(factorial(iterator), 4) * u128::pow(396, 4*iterator as u32)) as f64;
        approximation = 9801.0 / (2.0 * f64::powf(2.0, 1.0/2.0) * approximation_inverted);

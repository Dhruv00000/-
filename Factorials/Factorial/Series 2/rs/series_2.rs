...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += (u128::pow(factorial(2*iterator), 3) * (42 * iterator + 5) as u128) as f64 / (u128::pow(factorial(iterator), 6) * u128::pow(16, (3*iterator + 1) as u32)) as f64;

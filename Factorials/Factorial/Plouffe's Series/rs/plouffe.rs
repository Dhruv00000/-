...
fn main() {
    ...
    loop {
        ...
        approximation_intermediate += (iterator as u128 * u32::pow(2, iterator as u32) as u128 * u128::pow(factorial(iterator), 2)) as f64 / (factorial(2*iterator)) as f64;
        approximation = approximation_intermediate - 3.0;

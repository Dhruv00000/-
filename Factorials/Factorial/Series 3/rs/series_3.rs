...
fn main() {
    ...
    loop {
        ...
        approximation_inverted += i16::pow(-1, iterator as u32) as f64 * (factorial(4*iterator) * (21460 * iterator + 1123) as u128) as f64 / (u128::pow(factorial(iterator), 4) * u128::pow(441, (2*iterator + 1) as u32) * u128::pow(2, (10*iterator + 1) as u32)) as f64;

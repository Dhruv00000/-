...
fn main() {
    ...
    loop {
        ...
        approximation += 2.0 * ((factorial(iterator) as i128 * factorial(2*iterator) as i128 * (25 * (iterator as i128) - 3)) as f64 / ((factorial(3*iterator) * u8::pow(2, iterator as u32) as u128)) as f64);

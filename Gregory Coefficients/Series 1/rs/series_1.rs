...
fn main() {
    ...
    loop {
        ...
        approximation_intermediate += i8::pow(-1, iterator as u32) as f64 * (gregory_coefficient(3*iterator + 1) + gregory_coefficient(3*iterator + 2));
        approximation = f64::powf(3.0, 1.0/2.0) / approximation_intermediate / 2.0;

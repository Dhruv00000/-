...
fn main() {
    ...
    loop {
        ...
        approximation_squared += 1.0 / f64::powf(iterator as f64 + 1.0/2.0, 2.0); // The series was originally a summation over all integers, so I split it into positive and neagtive branches.
        if iterator != 0 { approximation_squared += 1.0 / f64::powf(1.0/2.0 - iterator as f64, 2.0); } // I'm checking here for k != 0 because without it, zero would be counted in both branches.
